...
export const APPLICATION_SUBCATEGORIES = [
  ...
  "Express Entry — FSW",
  "Express Entry — FST",
  "Express Entry — PNP (enhanced)",
  "Provincial Nominee — PNP (base)",
  "Provincial Nominee — OINP",
  "Provincial Nominee — BCPNP",
  "Provincial Nominee — AINP",
  "Provincial Nominee — SINP",
  "Provincial Nominee — MPNP",
  "Provincial Nominee — NBPNP",
  "Provincial Nominee — NSNP",
  "Provincial Nominee — AIPP",
  "Provincial Nominee — Other",
  "Work Permit — LMIA",
  "Work Permit — LMIA Exempt",
  "Work Permit — Spousal OWP",
  "Work Permit — Bridging OWP",
  "Work Permit — PGWP",
  "Work Permit — IEC",
  "Study Permit",
  "Visitor Visa / TRV",
